function [Iout1,param1] = DLMRIComplexValuedInputs(I1,Q1,sigma,sigmai,DLMRIparams)
...
for kp=1:num
    ...
    I11=(I11);  I11=I11/(max(max((abs(I11))))); Iiter=I11;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %[D,output] = KSVDC(YHU,param); %K-SVD with sparsity threshold only
